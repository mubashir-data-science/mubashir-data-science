...
**🛒 [SQL Sales Analysis](https://github.com/mubashir-data-science/sql-sales-analysis)**
25+ advanced SQL queries — revenue, CLV, cross-sell, window functions.
`SQL` `PostgreSQL`

</td>
<td width="50%" valign="top">

**🚀 [Big Data — Apache Spark](https://github.com/mubashir-data-science/spark-bigdata-ecommerce)**
50K transactions analyzed with Spark SQL & MLlib Random Forest.
`Scala` `PySpark`
